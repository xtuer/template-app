...
CREATE TABLE exam_question (
    ...
    type       tinyint(11) DEFAULT 0 COMMENT '题目类型: 0 (未知)、1 (单选题)、2 (多选题)、3 (判断题)、4 (问答题)、5 (填空题)、6 (复合题)、7 (标题)',
...
CREATE TABLE exam_paper_question (
    ...
    group_sn           int(11)      DEFAULT 0  COMMENT '大题分组序号，例如属于第一大题单选题组，顺序表示在试卷中的位置',
    position           int(11)      DEFAULT 0  COMMENT '题目在试卷里的位置',
    score              double       DEFAULT 0  COMMENT '每题得分 (创建试卷时大题下的题目使用)',
    total_score        double       DEFAULT 0  COMMENT '题目满分 (题目、大题、复合题的满分)',
    sn_label           varchar(128) DEFAULT '' COMMENT '试卷中题目的可读序号，例如 一、二、1、2、❶、❷ 等',
    parent_question_id bigint(20)   DEFAULT 0  COMMENT '材料题小题的大题 ID',
